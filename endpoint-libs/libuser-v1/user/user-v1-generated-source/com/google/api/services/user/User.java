 ...
 * on 2013-08-09 at 00:29:51 UTC 
 * Modify at your own risk.
 */

package com.google.api.services.user;
...
public class User extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetAllUser extends UserRequest<com.google.api.services.user.model.CollectionResponseUserApi> {
    ...
    protected GetAllUser() {
      super(User.this, "GET", REST_PATH, null, com.google.api.services.user.model.CollectionResponseUserApi.class);
    }
   ...
   * @return the request
   */
  public GetUserData getUserData(java.lang.Long id) throws java.io.IOException {
    GetUserData result = new GetUserData(id);
    initialize(result);
    return result;
  }

  public class GetUserData extends UserRequest<com.google.api.services.user.model.UserApi> {
     ...
     * @since 1.13
     */
    protected GetUserData(java.lang.Long id) {
      super(User.this, "GET", REST_PATH, null, com.google.api.services.user.model.UserApi.class);
    ...
    public GetUserData setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
   ...
   *
   * @param content the {@link com.google.api.services.user.model.UserApi}
   * @return the request
   */
  public InsertUser insertUser(com.google.api.services.user.model.UserApi content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserRequest<com.google.api.services.user.model.UserApi> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.google.api.services.user.model.UserApi content) {
      super(User.this, "POST", REST_PATH, content, com.google.api.services.user.model.UserApi.class);
    }
